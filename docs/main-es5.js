(function () {
  ...
  (self["webpackChunkng_pdf_highlighter"] = self["webpackChunkng_pdf_highlighter"] || []).push([["main"], {
    ...
    5041: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var popper_js_dist_umd_popper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! popper.js/dist/umd/popper.js */
      2049);
      /* harmony import */


      var popper_js_dist_umd_popper_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(popper_js_dist_umd_popper_js__WEBPACK_IMPORTED_MODULE_2__);
      /* harmony import */
      ...
      function AppComponent_div_9_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AppComponent_div_9_Template_div_click_0_listener($event) {
            var restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r3);

            var list_r1 = restoredCtx.$implicit;

            var ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            ctx_r2.moveTo(list_r1);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AppComponent_div_9_Template_i_click_2_listener($event) {
            var restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r3);
      ...
      var _AppComponent = /*#__PURE__*/function () {
        function _AppComponent() {
          ...
          this.element = null;
          this.areaInfo = []; // added new div with rects when pages rendered
        ...
        _createClass(_AppComponent, [{
          ...
          value: function mouseEvent(event) {
            if (!this.showPopup) {
              ...
              if (event.type === 'mousedown') {
                ...
                var path = this.composedPath(event.target);
                var eventPath = path.find(function (p) {
              ...
              if (event.type === 'mouseup') {
                ...
                if (this.rect.height > 0 && this.rect.width > 0) {
                  var popper = document.querySelector('.js-popper'); // tslint:disable-next-line:no-unused-expression
          ...
          key: "pageRendered",
          value: function pageRendered(event) {
            var _this = this;
            ...
            elem.style.cursor = 'crosshair'; // elem.style.background = 'red';
            // elem.style.opacity = '0.4';
            // console.log(event.target, 'target');

            var path = this.composedPath(event.source.div);
            path.find(function (p) {
              return p.className === 'page';
            }).appendChild(elem);
            jquery__WEBPACK_IMPORTED_MODULE_0__('.textLayer').addClass('disable-textLayer');
            var rectElem = this.areaInfo.find(function (f) {
              return f.pageNumber === _this.indexOfPage;
            });
            ...
            if (typeof rectElem !== 'undefined') {
              ...
              rect.style.height = rectElem.rect.height + 'px'; // get to-draw-rectangle div and add rectangle
          ...
          value: function _delete(list) {
            ...
            this.areaInfo.find(function (f) {
              return f.rectangleId === list.rectangleId;
            }).isDelete = true;
            this.areaInfo = this.areaInfo.filter(function (f) {
              return f.isDelete === false;
            });
          }
        }, {
          key: "moveTo",
          value: function moveTo(list) {
            ...
            if (this.listRectangleId !== list.rectangleId) {
              document.getElementById(list.rectangleId).scrollIntoView({
                block: 'start',
                behavior: 'smooth'
              });
      ...
      _AppComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function AppComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("mousemove", function AppComponent_Template_div_mousemove_10_listener($event) {
              return ctx.mouseEvent($event);
            })("mousedown", function AppComponent_Template_div_mousedown_10_listener($event) {
              return ctx.mouseEvent($event);
            })("mouseup", function AppComponent_Template_div_mouseup_10_listener($event) {
              return ctx.mouseEvent($event);
            });

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](11, "pdf-viewer", 8);

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("page-rendered", function AppComponent_Template_pdf_viewer_page_rendered_11_listener($event) {
              return ctx.pageRendered($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AppComponent_Template_i_click_14_listener() {
              return ctx.save();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AppComponent_Template_i_click_16_listener() {
              return ctx.cancel();
            });
    ...
    6747: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _AppModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        providers: [],
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__.BrowserModule, _app_routing_module__WEBPACK_IMPORTED_MODULE_0__.AppRoutingModule, _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormsModule, ng2_pdf_viewer__WEBPACK_IMPORTED_MODULE_5__.PdfViewerModule]]
      });
